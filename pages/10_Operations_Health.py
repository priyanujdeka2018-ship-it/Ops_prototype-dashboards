...
def main() -> None:
    render_module_hero(
        eyebrow="Regional command center",
        title="Operations Health",
        lede="One executive operating view across SLA, backlog, CSAT, quality, rework, and escalation risk.",
        answer="Where is the operation unhealthy, and which work types or teams need leadership attention?",
        why="This is the front door of the command center: it shows where to look before moving into recurrence, themes, quality, and capacity.",
        chips=[
            ("Synthetic data", SCALE_GOOD),
            ("Deterministic rules", SCALE_ACCENT),
            ("Executive view", SCALE_WARN),
        ],
    )

    render_demo_caption(
        "This is the front door: it tells me where the operation is unhealthy before I move into recurrence, themes, quality, and capacity."
    )

    render_decision_strip(
        signal="Regional health view across SLA, backlog, quality, CSAT, rework, and escalations.",
        driver="Rule-based anomalies and work-type health signals identify where leadership attention is needed.",
        decision="Decide which work type or team needs escalation, drilldown, or recovery focus this week.",
        monitor="SLA adherence, aged backlog, CSAT, quality score, rework rate, and escalation rate.",
    )
    ...
    st.markdown("---")
    st.caption(
        "Synthetic data only · deterministic rules · explainable scoring · no worker surveillance."
    )
